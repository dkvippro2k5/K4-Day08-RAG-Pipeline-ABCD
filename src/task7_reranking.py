...
def rerank(
    ...
    if method == "cross_encoder":
        ...
        # `candidates` ở đây là 1 danh sách đã có sẵn thứ hạng (vd: output của
        # semantic_search hoặc lexical_search). Wrap thành 1 ranked_list duy
        # nhất để tái dùng chung công thức RRF. Khi cần fuse NHIỀU nguồn cùng
        # lúc (Task 9: dense + sparse), gọi rerank_rrf() trực tiếp với
        # ranked_lists=[dense_results, sparse_results] thay vì qua hàm này.
